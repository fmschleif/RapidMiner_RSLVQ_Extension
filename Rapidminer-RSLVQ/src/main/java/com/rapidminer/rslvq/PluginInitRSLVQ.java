/*
 * Jan Engelhardt-Schieser
 * 
 * Copyright (C) 2018-2018 by Jan Engelhardt-Schieser and the contributors
 * 
 ...
 * @author REPLACEME
 */
public final class PluginInitRSLVQ {

		private PluginInitRSLVQ() {
